...
// Note that either the variables in TxHeaderOpt or those in MigrationHeaderOpt are nil.
...
// Note that either the variables in MigrationHeaderOpt or those in TxHeaderOpt are nil.
