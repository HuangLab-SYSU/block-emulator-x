...
type MigrationOpt struct {
	MigratedAddrs  []account.Address // MigratedAddrs is the list of accounts to be migrated in this stage.
	MigratedStates []account.State   // MigratedStates is the list of account states corresponding to accounts in MigratedAddrs.
}
