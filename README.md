...
![The system architecture of BlockEmulator](docs/figures/system-architecture.png)
...
![The execution flow of the supervisor](docs/figures/supervisor-exec-flow.png)
...
![The execution flow of the consensus nodes](docs/figures/consensusnode-exec-flow.png)
...
![The Generation of BlockOpts](docs/figures/blockopt-generation.png)
...
![The workflow of P2PConn](docs/figures/workflow-p2pconn.png)
...
![The transfer logic between `Payload` and `WrappedMsg`](docs/figures/msg-payload-transfer.png)
...
![The execution difference between BlockEmulator v1.0 and v2.0](docs/figures/exec-diff-v1v2.png)
